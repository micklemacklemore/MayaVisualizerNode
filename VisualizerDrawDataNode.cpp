...
//
void* VisualizerDrawDataNode::creator()
{
    return new VisualizerDrawDataNode();
}
...
//
MStatus VisualizerDrawDataNode::initialize()
{
#if 0
...
//
VisualizerDrawDataNode::VisualizerDrawDataNode() {}
...
//
MStatus VisualizerDrawDataNode::compute (const MPlug& plug, MDataBlock& data)
{
    ...
    if (plug == sOutput || plug == cOutput) {
        ...
        //
        MDataHandle sinHandle = data.outputValue( VisualizerDrawDataNode::sOutput,
                &returnStatus );
        CHECK_MSTATUS( returnStatus );
        MDataHandle cosHandle = data.outputValue( VisualizerDrawDataNode::cOutput,
                &returnStatus );
        CHECK_MSTATUS( returnStatus );
